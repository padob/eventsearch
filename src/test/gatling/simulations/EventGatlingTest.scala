...
class EventGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Event entity")
        ...
        .repeat(2) {
            ...
            .post("/api/events")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "startDate":"2020-01-01T00:00:00.000Z", "endDate":"2020-01-01T00:00:00.000Z", "language":"SAMPLE_TEXT", "fee":null, "place":"SAMPLE_TEXT", "address":"SAMPLE_TEXT", "registerationLink":"SAMPLE_TEXT", "eventWww":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
